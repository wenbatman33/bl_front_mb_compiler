...
export default {
  ...
  actions: {
    ...
    API_IndexPayment({ commit }) {
      const api = `${process.env.VUE_APP_APIHOST}/api/Payment/Deposit`;
    ...
    API_Withdraw({ commit }, payload) {
      return new Promise((resolve, reject) => {
        const api = `${process.env.VUE_APP_APIHOST}/api/Payment/Withdraw`;
        axios.post(api, payload).then((res) => {
          if (res.data.status === 1) {
            resolve(res);
          }
    ...
    API_MemberWallet({ commit }) {
      return new Promise((resolve, reject) => {
        const api = `${process.env.VUE_APP_APIHOST}/api/Member/Wallet`;
        axios.get(api).then((res) => {
    ...
    API_MemberWalletDetail({ commit }) {
      return new Promise((resolve, reject) => {
        const api = `${process.env.VUE_APP_APIHOST}/api/Member/UserGameCash`;
        axios.get(api).then((res) => {
          resolve(res);
        }).catch((err) => {
          reject(err);
    ...
    API_IndexTransactionLogTypeList({ commit }) {
      return new Promise((resolve, reject) => {
        const api = `${process.env.VUE_APP_APIHOST}/api/Member/TransactionLog/TypeList`;
        axios.get(api).then((res) => {
          resolve(res);
        }).catch((err) => {
          reject(err);
    ...
    API_MemberTransactionLog({ commit }, payload) {
      return new Promise((resolve, reject) => {
        const api = `${process.env.VUE_APP_APIHOST}/api/Member/TransactionLog`;
    ...
    API_MemberTransactionLogDetail({ commit }, payload) {
      return new Promise((resolve, reject) => {
        const api = `${process.env.VUE_APP_APIHOST}/api/Member/TransactionLog/Detail`;
        axios.get(api, payload).then((res) => {
          console.log(res);
