...
export default {
  ...
  actions: {
    // promotion
    API_IndexPromotion({ commit }) {
      return new Promise((resolve, reject) => {
        const api = `${process.env.VUE_APP_APIHOST}/api/FrontendPromotion`;
    ...
    API_PromotionDetail({ commit }, id) {
      return new Promise((resolve, reject) => {
        const api = `${process.env.VUE_APP_APIHOST}/api/FrontendPromotion/${id}`;
        axios.get(api).then((res) => {
    ...
    API_ApplyPromotion({ commit }, payload) {
      return new Promise((resolve, reject) => {
        const api = `${process.env.VUE_APP_APIHOST}/api/FrontendPromotion/Apply`;
    ...
    API_GiveUpPromotion({ commit }, payload) {
      return new Promise((resolve, reject) => {
        const api = `${process.env.VUE_APP_APIHOST}/api/FrontendPromotion/GiveUp`;
        axios.post(api, payload).then((res) => {
          resolve(res);
        }).catch((err) => {
          reject(err);
    ...
    API_IndexMyPromotion({ commit }, status = 0) {
      return new Promise((resolve, reject) => {
        const api = `${process.env.VUE_APP_APIHOST}/api/MyPromotion?status=${status}`;
        axios.get(api).then((res) => {
          if (status === 0) {
    ...
    API_MyPromotionDetail({ commit }, id) {
      return new Promise((resolve, reject) => {
        const api = `${process.env.VUE_APP_APIHOST}/api/MyPromotionDetail?promotion_id=${id}`;
        axios.get(api).then((res) => {
    ...
    API_PromotionDetailShow({ commit }, id) {
      return new Promise((resolve, reject) => {
        const api = `${process.env.VUE_APP_APIHOST}/api/promotionDetailShow/${id}`;
        axios.get(api).then((res) => {
    ...
    API_MyPromotionBonus({ commit }, payload) {
      return new Promise((resolve, reject) => {
        const api = `${process.env.VUE_APP_APIHOST}/api/MyPromotionBonus`;
        axios.post(api, payload).then((res) => {
          resolve(res);
        }).catch((err) => {
          reject(err);
