<template lang="pug">
  .promotionDetail(v-if="Promotion")
    ...
    .promotionDetail__main
      PromotionDetailForm(v-if="MyPromotionDetailShow[0].promotion.data[0].promotionType.value === 3" :id="MyPromotionDetailShow[0].id")
      PromotionDetailReward(v-else-if="MyPromotionDetailShow[0].promotion.data[0].promotionType.value === 2" :id="MyPromotionDetailShow[0].id")
      PromotionDetailBonus(v-else-if="MyPromotionDetailShow[0].promotion.data[0].promotionType.value === 1" :id="MyPromotionDetailShow[0].id")
</template>
