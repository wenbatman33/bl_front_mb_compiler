<template lang="pug">
  .promotionDetail(v-if="MyPromotionDetailShow[0] !== undefined")
    ...
    .promotionDetail__main
      PromotionDetailForm(v-if="MyPromotionDetailShow[0].promotion.data[0].promotionType.value === 3" :id="PromotionId")
      PromotionDetailReward(v-else-if="MyPromotionDetailShow[0].promotion.data[0].promotionType.value === 2" :id="PromotionId")
      PromotionDetailBonus(v-else-if="MyPromotionDetailShow[0].promotion.data[0].promotionType.value === 1" :id="PromotionId")
</template>
